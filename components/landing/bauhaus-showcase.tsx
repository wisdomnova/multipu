...
export function BauhausShowcase() {
  return (
    <section className="py-16 md:py-24 px-6 md:px-12 max-w-[1360px] mx-auto">
      {/* Outer rounded dark canvas */}
      <div className="w-full rounded-[40px] bg-neutral-950 p-8 sm:p-12 lg:p-16 overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-5 flex flex-col justify-between h-full min-h-[580px]">
            ...
            {/* Bauhaus Abstract Geometric SVG composition matching Screenshot 3 */}
          ...
          {/* Right Column: 2x2 Grid of 4 rounded colored feature tiles matching Screenshot 3 */}
