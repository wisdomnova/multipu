    ...
    >
      ...
      <motion.div variants={fadeUp} className="mb-6">
        ...
        >
          ...
          <span className="text-2xl sm:text-3xl text-white group-hover:translate-x-2 transition-transform">
            →
          </span>
        </Link>
      </motion.div>
          ...
          <div className="lg:col-span-5 flex flex-col justify-between">
            <div>
              <Link href="/" className="inline-flex items-center gap-4 group mb-4">
                ...
                <span className="text-3xl sm:text-4xl font-bold tracking-tighter text-white font-mono uppercase">
                  MULTIPU
                </span>
              </Link>
