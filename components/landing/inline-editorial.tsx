    ...
    >
      ...
      <motion.div variants={fadeUp} className="mb-20 md:mb-28 max-w-5xl">
        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-normal tracking-tight text-white leading-[1.3] md:leading-[1.25]">
          ...
          has been deploying{" "}
          <span className="inline-flex items-center justify-center align-middle w-7 h-7 sm:w-8 sm:h-8 text-white mx-1">
            {/* Lightning bolt SVG */}
          ...
          <span className="inline-flex items-center gap-1.5 px-3 py-1 sm:px-4 sm:py-1.5 rounded-xl bg-orange-600 text-white text-sm sm:text-base font-semibold align-middle mx-1">
            <span>✱</span>
            <span>Multipu</span>
          </span>{" "}
          6 ecosystems. A platform of 100K+{" "}
          <span className="inline-flex items-center justify-center align-middle w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-white mx-1 text-black text-[10px] font-bold">
            ●
          </span>{" "}
          creators.
        </h2>
